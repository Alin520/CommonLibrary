package com.alin.commonlibrary.permissions;
...
import com.alin.commonlibrary.util.Config;
...
//     * @param     申请的权限集合
     ...
     */
    public void startRequestPermission(Permission permission,RequestPermissionsListener permissionsListener){
