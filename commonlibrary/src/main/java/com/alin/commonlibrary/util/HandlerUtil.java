...
public class HandlerUtil {
    ...
    private HandlerUtil(Handler handler, Build build) {
        mHandler = handler;
        mBuild = build;
    }
    ...
    public HandlerUtil removeCallback(Runnable task){
        AppUtil.checkNotNull(task,"Runnable = null");
        mHandler.removeCallbacks(task);
        return this;
    }

    public HandlerUtil removeCallbackAndMessages(Object message){
        AppUtil.checkNotNull(message,"message = null");
        mHandler.removeCallbacksAndMessages(message);
        return this;
    }
